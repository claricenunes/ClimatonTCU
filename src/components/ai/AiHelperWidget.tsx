...
const QUESTIONS: CannedQuestion[] = [
  ...
  },
  {
    ...
    answer: "O SituaMap acompanha os 26 estados e o Distrito Federal, com indicadores atualizados regularmente.",
  },
  {
    question: "Como faço um relato da minha região?",
    answer: "Acesse a página Comunidade e clique em \"Fazer um relato\" para compartilhar o que está acontecendo perto de você.",
  },
  {
    ...
    <div className="fixed bottom-5 right-5 z-40 flex flex-col items-end gap-3 sm:bottom-8 sm:right-8">
      ...
      {open && (
        <div
          ...
          role="dialog"
          aria-modal="false"
          aria-label="Assistente do SituaMap"
        ...
        >
          <div className="flex items-center justify-between border-b border-ink-100 px-4 py-3">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm font-bold text-ink-900">Assistente SituaMap</p>
            </div>
            <button
              onClick={closePanel}
      ...
      <button
        ...
        className="flex size-20 shrink-0 items-center justify-center rounded-full border-[3px] border-accent-500 bg-white shadow-elevated transition-transform hover:scale-105 active:scale-95 sm:size-24"
      >
